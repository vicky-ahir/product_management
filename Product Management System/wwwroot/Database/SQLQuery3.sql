...
GO
/****** Object:  StoredProcedure [dbo].[sp_UserLogin]    Script Date: 14-04-2024 11:39:40 AM ******/
DROP PROCEDURE [dbo].[sp_UserLogin]
GO
/****** Object:  StoredProcedure [dbo].[sp_UserDetails]    Script Date: 14-04-2024 11:39:40 AM ******/
DROP PROCEDURE [dbo].[sp_UserDetails]
GO
/****** Object:  StoredProcedure [dbo].[sp_Product_Details]    Script Date: 14-04-2024 11:39:40 AM ******/
DROP PROCEDURE [dbo].[sp_Product_Details]
GO
/****** Object:  StoredProcedure [dbo].[sp_Order_Completed]    Script Date: 14-04-2024 11:39:40 AM ******/
DROP PROCEDURE [dbo].[sp_Order_Completed]
GO
/****** Object:  StoredProcedure [dbo].[sp_Get_Order_Details]    Script Date: 14-04-2024 11:39:40 AM ******/
DROP PROCEDURE [dbo].[sp_Get_Order_Details]
GO
/****** Object:  StoredProcedure [dbo].[sp_Cart_Details]    Script Date: 14-04-2024 11:39:40 AM ******/
DROP PROCEDURE [dbo].[sp_Cart_Details]
GO
/****** Object:  Table [dbo].[User]    Script Date: 14-04-2024 11:39:40 AM ******/
IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[User]') AND type in (N'U'))
DROP TABLE [dbo].[User]
GO
/****** Object:  Table [dbo].[Product]    Script Date: 14-04-2024 11:39:40 AM ******/
IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[Product]') AND type in (N'U'))
DROP TABLE [dbo].[Product]
GO
/****** Object:  Table [dbo].[Cart]    Script Date: 14-04-2024 11:39:40 AM ******/
IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[Cart]') AND type in (N'U'))
DROP TABLE [dbo].[Cart]
GO
USE [master]
GO
/****** Object:  Database [Product Management]    Script Date: 14-04-2024 11:39:40 AM ******/
...
USE [Product Management]
GO
/****** Object:  Table [dbo].[Cart]    Script Date: 14-04-2024 11:39:41 AM ******/
SET ANSI_NULLS ON
GO
...
GO
/****** Object:  Table [dbo].[Product]    Script Date: 14-04-2024 11:39:42 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[User]    Script Date: 14-04-2024 11:39:42 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  StoredProcedure [dbo].[sp_Cart_Details]    Script Date: 14-04-2024 11:39:42 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END
GO
/****** Object:  StoredProcedure [dbo].[sp_Get_Order_Details]    Script Date: 14-04-2024 11:39:42 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END
GO
/****** Object:  StoredProcedure [dbo].[sp_Order_Completed]    Script Date: 14-04-2024 11:39:42 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
BEGIN          
 ...
 END 
GO
/****** Object:  StoredProcedure [dbo].[sp_Product_Details]    Script Date: 14-04-2024 11:39:42 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END
GO
/****** Object:  StoredProcedure [dbo].[sp_UserDetails]    Script Date: 14-04-2024 11:39:42 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
IF @sp_operation = 'INSERT'  
	 BEGIN  
	  INSERT INTO dbo.[User] (Firstname, Lastname, Birthdate, Gender, Email, Phonenumber, [Password], Is_Deleted)    
	  VALUES (@Firstname,@Lastname,@Birthdate,@Gender,@Email,@Phonenumber,@Password, 0)    
	 END  
...
END
GO
/****** Object:  StoredProcedure [dbo].[sp_UserLogin]    Script Date: 14-04-2024 11:39:42 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
